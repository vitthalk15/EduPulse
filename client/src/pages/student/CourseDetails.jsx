    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className='max-w-xl z-10 text-gray-500'>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>EduPulse</span></p>
              ...
              {courseData.courseContent.map((chapter, index) => (
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={() => toggleSection(index)}>
                    ...
                    <p className='text-sm md:text-[15px,21px]'>{chapter.chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
                  </div>
          ...
          <div className='py-20 text-sm md:text-[15px,21px]'>
        ...
        {/* right column */}
        <div className="max-w-[26.5rem] z-10 shadow-md rounded-t md:rounded-none overflow-hidden bg-white min-w-[18.75rem] sm:min-w-[26.25rem]">
          ...
          <div className='p-5'>
            ...
            <div className='pt-6'>
              ...
              <ul className='ml-4 pt-2 text-sm md:text-[15px,21px] list-disc text-gray-500'>
